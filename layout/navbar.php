<nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.php" data-aos="fade-right" data-aos-duration="1000">
            <img src="assets/images/logo.png" class="img-fluid" style="width:50px;" alt="">
            Hornbill Blog
          </a>
              ...
              <?php if(isset($_SESSION['user'])): ?>
                  ...
                  <li class="nav-item">
                    <form method="post">
                      ...
                      <button class="btn nav-link" type="submit" name="signOutBtn" onclick="return confirm('Are you sure to sign out?')">Sign Out</button>
                    </form>
                  </li>
                <?php else: ?>
                  <li class="nav-item">
