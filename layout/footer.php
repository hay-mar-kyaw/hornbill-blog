<?php 
    ...
    if(isset($_POST['userSignUpBtn'])){
        ...
        if($name != '' && $email != '' && $password != ''){
            ...
            $result=$stmt->execute();
            if($result){
                echo"<script>sweetAlert('registered','index.php')</script>" ; 
            }
        }
        ...
        <div class="offcanvas-body">
          <div class="">
            <form action="" method="post">
                ...
                <button name="signInBtn" type="submit" class="btn">Sign In</button>
            </form>
            <a class="d-block my-3" href="#signUp" data-bs-toggle="offcanvas" aria-controls="staticBackdrop" >You have no account yet!click here</a>
          </div>
        </div>
    </div>
