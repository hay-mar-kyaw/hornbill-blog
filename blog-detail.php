<?php 
    ...
    #get blog data
    $blogId=$_GET['blog_id'];
    $blogStmt=$db->prepare("SELECT blogs.id,blogs.title,blogs.content,blogs.created_at,blogs.image,users.name FROM blogs INNER JOIN users ON blogs.id=users.id WHERE blogs.id=$blogId");
    $blogStmt->execute();
    ...
    $commentStmt=$db->prepare("SELECT comments.text,comments.created_at,users.name FROM comments INNER JOIN users ON comments.user_id=users.id WHERE comments.blog_id=$blogId ORDER BY comments.id DESC");
    $commentStmt->execute();
            ...
            <div class="row mt-5">
                <div class="col-md-8">
                    ...
                    <div class="comment">
                        ...
                        <h6 class="fw-bold mt-5">Users's Comments</h6>
